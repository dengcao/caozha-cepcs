...
(function () {
	...
	UploadImage.prototype = {
		...
		initUploader: function () {
			...
			//if (iswater == ''){iswater = 1;}
			//actionUrl = actionUrl + '&iswater=' + iswater;

			$('.iswater_a').click(function () {
				iswater = 1;
				actionUrl = actionUrl + '&iswater=1';
			})
			$('.iswater_b').click(function () {
				iswater = 0;
				actionUrl = actionUrl + '&iswater=0';
			})
